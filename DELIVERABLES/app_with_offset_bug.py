        ...
        ui.nav_panel("🧠 Models",
            ui.layout_sidebar(
                ui.sidebar(
                    ui.input_select("model_select", "Select Classifier", MODEL_NAMES),
                    ui.input_select("quadrant", "Select Quadrant", ["Q1", "Q2", "Q3", "Q4"]),
                    ui.input_action_button("run_all_quadrants", "🚀 Run All Quadrants", width="100%"),
                    ui.hr(),
                    ui.input_action_button("clear_cache_btn", "🧹 Clear Cache")
                ),
                ui.layout_columns(
                    ui.card(ui.h2("🗺️ Heatmap from CV"),
                            ui.output_plot("decision_boundary_plot"), full_screen=True),
                    ui.card(ui.h2("📈 Performance Metrics"),
                            ui.output_plot("cv_metrics_plot"), full_screen=True),
                    ui.card(ui.h2("📊 Distributions"),
                            ui.output_plot("cv_distribution_plot"), full_screen=True),
                    ui.card(ui.h2("🧾 Outer Model Metrics"),
                            ui.output_plot("outer_model_metrics"), full_screen=True),
                    ui.card(ui.h2("🔬 Largest Tumour Mass"),
                            ui.output_plot("largest_tumour_mass_plot"), full_screen=True),
                    ui.card(ui.h2("🎯 Scatter Plot"),
                            ui.output_plot("scatter_plot"), full_screen=True),
                    ui.card(ui.h2("🏁 Performance"),
                            ui.output_plot("performance_plot"), full_screen=True),
                    ui.card(ui.h2("📦 CV Metric Boxplot"),
                            ui.output_plot("cv_metrics_boxplot"), full_screen=True),
                    col_widths=[6, 6]
                )
            )
        ),
        ...
        ui.nav_panel("🖼️ Image Test (IN PROGRESS, DO NOT USE)",
            ui.layout_sidebar(
                ui.sidebar(
                    ...
                    ui.output_text("upload_progress"),
                    ui.hr(),
                    ui.input_action_button("clear_cache_btn_upload", "🧹 Clear Cache")
                ),
                ui.layout_columns(
                    ui.card(ui.h2("🌡️ Full Image Heatmap"),
                            ui.output_plot("upload_heatmap"), full_screen=True),
                    ui.card(ui.h2("📊 Prediction Distribution"),
                            ui.output_plot("upload_distribution"), full_screen=True),
                    ui.card(ui.h2("📉 Tumour Cell Percentage"),
                            ui.output_plot("upload_percent_tumour"), full_screen=True),
                    ui.card(ui.h2("🧬 Largest Tumour Cell Mass"),
                            ui.output_plot("upload_largest_mass"), full_screen=True),
                    col_widths=[6, 6]
                )
            )
        )
