                 ...
                 ui.card(
                     ...
                     ui.tags.div(
                         ...
                         ui.tags.ul(
                            ...
                            ui.tags.li(
                                "Switch to the ", ui.strong('Whole Slide Prediction'), " tab to upload your own H&E stained image, and generate predictions in real time.")
                         ),
                         class_="mb-4"
                     ),
...
def server(input, output, session):
    ...
    def upload_distribution():
        if input.image_upload():
            ...
            plt.text(0.5, 0.5, "Waiting for Upload of Image", ha='center', va='center')
            plt.axis('off')
